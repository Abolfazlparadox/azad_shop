...
#             path('roles/add/', self.admin_view(self.add_role_view), name='add_role'),
...
#         })
#
#     def add_role_view(self, request):
#         try:
#             university = request.user.memberships.get(role='OFFI').university
#             if request.method == 'POST':
#                 form = RoleCreationForm(request.POST, university=university)
#                 if form.is_valid():
#                     membership = form.save(commit=False)
#                     membership.university = university
#                     membership.is_confirmed = True  # Auto-confirm for unit admin
...
#                     return redirect('unit_admin:role_list')
#             else:
#                 form = RoleCreationForm(university=university)
#
#             return render(request, 'unit_admin/add-new-roll.html', {
#                 'form': form,
#                 **self.each_context(request),
#             })
#
